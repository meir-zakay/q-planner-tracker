                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1.5">
                        ...
                        <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${
                          feature.featureStatus === 'Done' ? 'bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300' :
                          feature.featureStatus === 'Blocked' ? 'bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300' :
                          feature.featureStatus === 'On Hold' ? 'bg-orange-100 text-orange-700 dark:bg-orange-900/40 dark:text-orange-300' :
                          feature.featureStatus === 'Testing' ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300' :
                          feature.featureStatus === 'In Progress' ? 'bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-300' :
